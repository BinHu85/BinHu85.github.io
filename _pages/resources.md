...
<div class="equipment-grid">
  ...
  <div class="equipment-card">
    <img src="/assets/img/facilities/crazyflie.png" alt="Crazyflie 2.1 Brushless AI Bundle" class="equipment-image">
    <div class="equipment-title">Crazyflie 2.1 Brushless AI Bundle (4 units)</div>
    <div class="equipment-description">Compact, versatile nano quadcopter platform with AI-deck for onboard neural network inference, enabling swarm research and edge AI experimentation.</div>
  </div>
</div>
...
<div class="equipment-grid">
  <div class="equipment-card">
    ...
    <div class="equipment-title">NVIDIA Jetson AGX Orin 64GB Dev Kit (3 units)</div>
  ...
  <div class="equipment-card">
    <img src="/assets/img/facilities/nvidia6000.jpg" alt="NVIDIA RTX PRO 6000" class="equipment-image">
    <div class="equipment-title">NVIDIA RTX PRO 6000 Blackwell Max-Q Workstation Edition (4 units)</div>
    <div class="equipment-description">Professional-grade GPU workstations powered by NVIDIA Blackwell architecture for large-scale AI training, deep learning, and high-performance computing research.</div>
  </div>
  ...
  <div class="equipment-card">
    ...
    <div class="equipment-title">Jetson Nano Development Kit (5 units)</div>
    <div class="equipment-description">Entry-level AI and robotics development platform perfect for learning, prototyping, and deploying AI applications at the edge. Includes 4x Jetson Orin Nano and 1x original Jetson Nano.</div>
  </div>

  <div class="equipment-card">
    <img src="/assets/img/facilities/max78000.jpg" alt="MAX78000 Evaluation Kit" class="equipment-image">
    <div class="equipment-title">MAX78000/MAX78002 Microcontrollers (10 units)</div>
    <div class="equipment-description">Ultra-low-power AI microcontrollers with hardware-accelerated neural network processing for battery-powered edge AI applications. Includes 6x MAX78000 evaluation boards, 2x MAX78002 evaluation boards, and 2x MAX78000 Feather boards.</div>
  </div>
